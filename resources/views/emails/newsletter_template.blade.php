<div style="max-width: 75%; text-align: left; padding: 20px 30px; border: 0px solid #000; margin: auto">
    ...
    <div style="text-align: left;">
        ...
        Dzielimy się radością 5% rabatu czeka. 🚀<br>
        <br>
        Użyj przy zamówieniu kodu CZPOOMA87X<br>
        <br>
        Wbijaj i Odziej się! 👉 <a href="https://www.odziejsie.pl">https://www.odziejsie.pl</a><br><br>
        <a href="https://www.odziejsie.pl"><img src="https://admail.agencjamedialna.pro/assets/img/odziejsie.jpeg" alt="" width="640"></a><br><br>
    ...
    <a href="https://admail.agencjamedialna.pro/anuluj-subskrypcje/{{ $userData['token'] }}" style="background: darkblue; 
                color: #fff; 
                padding: 10px 20px; 
                border-radius: 3px;
                margin-bottom: 20px;
